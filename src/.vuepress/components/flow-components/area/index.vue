<template>
  <div :class="[`distpicker-address-wrapper`, custom ? custom : '']">
    <!-- <label> -->
    <select v-model="curPro" name="province" @change="getPro()" :disabled="provinceDisabled">
      <option :value="placeholders.province">
        {{ placeholders.province }}
      </option>
      <option v-for="(item, key) in provinces" :value="key" :key="key" :label="item">
        {{ item }}
      </option>
    </select>
    <!-- </label> -->
    <!-- <label v-if="!onlyProvince"> -->
    <select v-if="!onlyProvince" name="city" v-model="curCity" @change="getCity" :disabled="cityDisabled">
      <option :value="placeholders.city">{{ placeholders.city }}</option>
      <option v-for="(item, key) in citys" :value="key" :key="key" :label="item">
        {{ item }}
      </option>
    </select>
    <!-- </label> -->
    <!-- <label  v-if="!hideArea && !onlyProvince" > -->
    <select v-if="!hideArea && !onlyProvince" name="area" v-model="curArea" @change="getArea" :disabled="areaDisabled">
      <option :value="placeholders.area">{{ placeholders.area }}</option>
      <option v-for="(item, key) in areas" :value="key" :key="key" :label="item">
        {{ item }}
      </option>
    </select>
    <!-- </label> -->
...
export default {
  ...
  created() {
    ...
    this.curPro = this.format(this.province, 'curPro') || this.placeholders.province
