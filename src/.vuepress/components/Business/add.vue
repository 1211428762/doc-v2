<template>
  <div>
    <el-dialog :close-on-click-modal="false" :title="form.id ? '修改' : '新增'" v-model="visible">
      <FormList :formData="form" v-model:elForm="elForm" ref="formList" :fieldList="formItem" label-width="120px">
